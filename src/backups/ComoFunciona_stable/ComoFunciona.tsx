          ...
          <div className="w-full grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-7 flex items-center justify-center relative">
              <div className="relative w-full aspect-video max-h-[520px] lg:max-h-[580px] flex items-center justify-center bg-transparent organic-video-mask overflow-hidden">
                ...
                <canvas
                  ref={canvas1Ref}
                  className={`absolute inset-0 w-full h-full object-contain scale-[1.05] lg:scale-[1.10] organic-video-mask mix-blend-multiply brightness-[1.01] contrast-[1.02] transition-opacity duration-300 pointer-events-none ${
